import { createSlice, createSelector, PayloadAction, Reducer, AnyAction } from '@reduxjs/toolkit';
import { Ingredient, ConstructorIngredient, ConstructorState, RootState } from '@utils/types';
...
export const selectBun = createSelector(
  [getBun],
  (bun): Ingredient | null => bun ? { ...bun } : null
);
