...
import { User, AuthState, AuthResponse, RootState } from '../../utils/types';
import {
	RegisterData,
	LoginData,
	UpdateUserData,
...
>('auth/updateUser', async (userData, { getState, rejectWithValue }) => {
	const { auth } = getState();
	...
	extraReducers: (builder) => {
		...
		builder
			...
			.addCase(refreshToken.fulfilled, (state, action) => {
				...
				console.log(
					'[AUTH] refreshToken.fulfilled - Token refreshed successfully'
				);
